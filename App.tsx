  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <footer className="text-center p-4 mt-8 text-xs text-gray-500 print:hidden">
        <p>&copy; 2024 ImpactSphere v3.11. Made by <a href="https://www.myherb.co.il/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">myHerb</a> as a part of DevSphere - Sustainable Development.</p>
      </footer>
    </div>
  );
};
