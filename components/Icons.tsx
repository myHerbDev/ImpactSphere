...
export const LeafIcon: React.FC = () => (
  <svg 
    ...
    viewBox="0 0 32 32"
    >
    <path d="M16 4L4 28H28L16 4Z" fill="#10b981"/>
    <path d="M16 4L28 28L16 20L16 4Z" fill="#a7f3d0" fillOpacity="0.6"/>
  </svg>
);
...
export const ChallengesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
export const DataEntryIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
);

export const ReportingIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
export const FlaskIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.572l-7.5-7.5a.6.6 0 00-.848 0l-7.5 7.5A.6.6 0 004 13.5h16a.6.6 0 00.348-.928z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 13.5v8.25" />
...
export const KeyIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4v-1.258l-2.247-2.247a1 1 0 010-1.414L5.758 11.09a6 6 0 011.742-1.742" />
    </svg>
);
